...
# CAM batch processing for NBA videos - VideoMAEv2 version
# Processes 3 players, 3 videos each (freethrow), 2 checkpoints, 2 CAM methods
# Usage: ./videomaev2_app.sh [GPU_ID]
# Example: ./videomaev2_app.sh 0  (use GPU 0)
#          ./videomaev2_app.sh     (use default GPU 0)
...
OUTPUT_BASE="/home/zhang.13617/Desktop/zhang.13617/NBA/videomaev2_app"

# Set GPU device
export CUDA_VISIBLE_DEVICES=$GPU_ID

# List of checkpoints for testing
CHECKPOINTS=(
    "/home/zhang.13617/Desktop/zhang.13617/NBA/ckpt/mae_new/VideoMAEv2_ckpt/VideoMAEv2_v3_appearance_beginning_nosplitsampling.pth"
    "/home/zhang.13617/Desktop/zhang.13617/NBA/ckpt/mae_new/VideoMAEv2_ckpt/VideoMAEv2_v3_appearance_beginning_splitsampling.pth"
)

# Checkpoint names for output directories
CHECKPOINT_NAMES=(
    "VideoMAEv2_v3_appearance_beginning_nosplitsampling"
    "VideoMAEv2_v3_appearance_beginning_splitsampling"
)
    ...
    for player in "${PLAYERS[@]}"; do
        ...
        for i in {0..2}; do
            ...
            for method in "${CAM_METHODS[@]}"; do
                ...
                # Run the CAM script
                python3 "$SCRIPT_DIR/run_gradcam_videomaev2.py" \
                    --video "$VIDEO_PATH" \
...
echo "=========================================="
echo "Total runs: $total_runs (2 checkpoints × 3 players × 3 videos × 2 methods = 36 runs)"
